...
public class SellerMinion extends Minion {
    ...
    public SellerMinion(UUID ownerUUID, double x, double y, double z, String world, MinionFace minionFace, double chestX, double chestY, double chestZ, String chestWorld, int stat, int level, int hunger) {
